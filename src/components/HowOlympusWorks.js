...
function HowOlympusWorks() {
  return (
    <section className="how-olympus-works-section">
      <h2>How Exodus Works</h2>
      <div className="container">
        <div className="row">
          <div className="left-col">
            <h5>
              <span className="number">1</span> Treasury Revenue{" "}
            </h5>
            <h3>Bonds & LP fees</h3>
            <p>
        ...
        <div className="row-2">
          ...
          <div className="content">
            ...
            <div className="right-col">
              <h5>
                <span className="number">2</span> Treasury Growth
              </h5>
              <h3>Exodus Treasury</h3>
              <p>
        ...
        <div className="row">
          <div className="left-col">
            <h5>
              <span className="number">3</span> Staking Rewards{" "}
            </h5>
            <h3>EXO Token</h3>
            <p>
